...
from utils import check_type, convert_hexidecimal_to_float32_ieee_754, convert_float32_to_hexidecimal_ieee_754, check_limit, delay

from controller import Controller

from peltier_communication import PeltierCommunication
from peltier_payload import PeltierPayload
from peltier_parameters import PELTIER_PARAMETERS
...
class Meerstetter():
    ...
    __target_temperatures = [None for i in range(1,10)]
    ...
    def reset_device(self, address):
        ...
        from crc import compute_crc16_xmodem
        # Setup the logger.
